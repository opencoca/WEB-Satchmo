    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.OneToOneField(to='auth.Group', help_text='The user group that will receive the discount')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pricingtier', models.ForeignKey(related_name='tieredprices', to='tieredpricing.PricingTier')),
                ('product', models.ForeignKey(related_name='tieredprices', to='product.Product')),
            ],
            options={
