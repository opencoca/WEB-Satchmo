    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('credit_type', models.CharField(max_length=16, verbose_name='Credit Card Type', choices=[(b'American Express', 'American Express'), (b'Visa', 'Visa'), (b'Mastercard', 'Mastercard'), (b'Discover', 'Discover')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('optionName', models.CharField(help_text='The class name as defined in payment.py', unique=True, max_length=20, verbose_name='Option Name', choices=[('AUTHORIZENET', 'Credit Cards'), ('GIFTCERTIFICATE', 'Gift Certificate'), ('DUMMY', 'Payment test module')])),
